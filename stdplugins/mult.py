...
async def common_outgoing_handler(e):
    ...
    if find=="delmsg" :
        ...
        await e.edit("Report bugs here: @lucifertheking")

    elif find == "fork":

        await e.edit('https://github.com/ravana69/uniborg')
        ...
        await e.edit("hail uniborg ! ( ͡° ͜ʖ ͡°)")
        ...
        await e.edit("`Master! I am Uniborg 🔥`")
        ...
        await borg.send_message(-1001430364876,"You had recieved "+str(COUNT_MSG)+" messages from "+str(len(USERS))+" chats while you were away")

        for i in USERS:

            await borg.send_message(-1001430364876,str(i)+" sent you "+"`"+str(USERS[i])+" messages`")
        ...
        reactor=['Runs towards Modi for Achey Dinn','Runs Towards Donald Trumpet for help','Runs to Kaala','Runs to Thanos','Runs far, far away from earth','Running faster than ussain bolt coz I\'mma Bot','Runs towards Death']
