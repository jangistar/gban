...
sudo apt install libleveldb-dev libffi-dev libssl-dev git-all python3 python3-pip
...
git cloning the repo locally
sudo git clone https://github.com/jangistar/gban
...
deploying gban bot on local machine
sudo python3 -m stdborg 5
